...
// app.post("/follow/:following_id", async (req, res) => {
//   const { following_id } = req.params;  // following_id is the user who wants to follow
...
//   const existingFollower = await Follower.findOne({ where: { user_id, following_id } });
...
console.log("Salah server anjay!!!!")